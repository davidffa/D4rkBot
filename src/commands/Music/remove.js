module.exports = {
    ...
    execute(client, message, args) {
        ...
        if ((player.queue[parseInt(args[0])-1] && message.author.id === player.queue[parseInt(args[0])-1].requester.id)
        ...
        if (guild && guild.djrole) {
            ...
            return message.channel.send(`:x: Apenas quem requisitou essa música, alguém com o cargo DJ: \`${role.name}\` ou com a permissão \`Mover Membros\` pode usar este comando (ou de estar sozinho com o bot no canal de voz)!`);
        }
